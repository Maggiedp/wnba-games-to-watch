...
def _seed(env):
    session = get_session()
    q.upsert_shot_making(session, 2026, "10", athlete_name="Hot", team_id="1",
        team_abbr="LV", fga=150,
    ...
    q.upsert_shot_making(session, 2026, "11", athlete_name="Cold", team_id="2",
        team_abbr="TOR", fga=150,
