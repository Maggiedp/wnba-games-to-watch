...
- **Importance (40%)** — Monte Carlo simulation (2,000 runs per forced outcome) over the next 30 days, measuring how much each team's playoff odds swing on tonight's result. Per-game win probabilities use Elo ratings with home-court advantage and a margin-of-victory multiplier, replayed chronologically from 2024 with a 1/3 regression toward the mean at each season boundary.
